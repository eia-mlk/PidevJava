...
public class MyReclamationsController implements Initializable {
                ...
                return new TableCell<Reclamation, Void>() {
...

                    {
                        modifyButton.setOnAction(event -> {
                                ...
                                Reclamation selectedRec= getTableView().getItems().get(getIndex());
                                FXMLLoader loader = new FXMLLoader(getClass().getResource("/modifierReclamation.fxml"));
                                Parent root;
                                try {
                                    root = loader.load();
                                    ModifierReclamation controller = loader.getController();
                                    controller.initData(selectedRec);
                                    ...
                                    Logger.getLogger(MyReclamationsController.class.getName()).log(Level.SEVERE, null, ex);
                                }
